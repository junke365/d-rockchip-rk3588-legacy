...
#define TSK_TI_LOCAL_FLAGS 8 /* offsetof(struct task_struct, thread_info.local_flags) */
#define TSK_TI_PREEMPT 24 /* offsetof(struct task_struct, thread_info.preempt_count) */
#define TSK_TI_ADDR_LIMIT 16 /* offsetof(struct task_struct, thread_info.addr_limit) */
...
#define THREAD_KEYS_USER 2728 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 2808 /* offsetof(struct task_struct, thread.keys_kernel) */
